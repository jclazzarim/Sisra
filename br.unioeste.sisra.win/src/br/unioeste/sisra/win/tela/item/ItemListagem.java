 ...
 * @author Charlinho
 */
public class ItemListagem extends javax.swing.JPanel {
     ...
     */
    public ItemListagem(ItemActivity activity, Handler handler) {
    ...
    private void btnNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNovoActionPerformed
         activity.abrirFormularioItem(null);
    }//GEN-LAST:event_btnNovoActionPerformed

    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
           try {
            activity.buscarItem(txtBusca.getText(), FuncionarioActivity.Campo.ID);
        } catch (Exception e) {
            handler.handle(e);
        }
    ...
    private void initTabelaItems() {
        ...
        colunas[ItemActivity.Campo.ID] = "Id";
        colunas[ItemActivity.Campo.NOME] = "Nome";
        colunas[ItemActivity.Campo.CODIGO] = "Codigo";
        colunas[ItemActivity.Campo.PRECO] = "Preço";
        colunas[ItemActivity.Campo.DESCRICAO] = "Descrição";


        tblItemModel = new SimpleTableModel(dadosTabela, colunas);
    }

    public void exibeBusca(ItemTO[] itens) {
    ...
    public void atualizaItem(ItemTO f) {
        final int idLinha = tblItemModel.getIdLinha(ItemActivity.Campo.ID, String.valueOf(f.getId()));
        if (idLinha >= 0) {
    ...
    private String[] toArrayString(ItemTO i) {
